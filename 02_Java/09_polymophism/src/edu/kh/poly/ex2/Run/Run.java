...
import edu.kh.poly.ex2.model.service.SGHCalulator;
...
//	  service.ex2();
	  ...
	  SGHCalulator cal = new SGHCalulator();
	  ...
	  // 인터페이스 == 미완성 설계도 == 객체화 불가
	  
	  // -> 추상클래스처럼 잠조 변수로는 사용 가능
	  ...
	  //이를 이용하여 중요한 메인코드의 수정을 최소할 수 있다
	  ...
	  // 이를 이용하여 공동 작업에 필요한 개발환경을 조성할 수 있다.
} 
}
